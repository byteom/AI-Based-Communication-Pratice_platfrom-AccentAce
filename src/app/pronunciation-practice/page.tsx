...
import { Loader2, Mic, Pause, StopCircle, Volume2, Waves, History, MessageCircleQuestion, ChevronsRight } from 'lucide-react';
import { addHistoryItem, updateHistoryItem, getHistoryItems } from '@/services/pronunciationPracticeHistoryService';
      ...
      <div className="container mx-auto p-4 sm:p-6 lg:p-8">
        <header className="flex items-center justify-between pb-6 border-b">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-3xl font-bold font-headline tracking-tight">Pronunciation Practice</h1>
          </div>
              ...
              <Card className="shadow-md">
                ...
                <CardContent className="space-y-6">
                  <div className="text-center p-6 bg-muted rounded-lg">
                    <p className="text-xl font-serif">"{phrase}"</p>
                  </div>
                  <div className="flex items-center justify-center p-4 bg-muted/50 rounded-lg gap-2">
                    <Button onClick={() => handlePlayReference()} size="lg" variant="outline" aria-label="Play reference audio" disabled={!referenceAudioUrl}>
                      {isSpeaking ? <><Pause className="mr-2" /> Stop</> : <><Volume2 className="mr-2" /> Play Reference</>}
                    </Button>
                    <div className="w-32">
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    <Button onClick={handleAnalyze} disabled={!recordedAudio || isAnalyzing || isRecording || !currentHistoryId} size="lg" className="w-full sm:w-auto">
                      {isAnalyzing ? <><Loader2 className="mr-2 animate-spin" /> Analyzing...</> : 'Analyze My Speech'}
                    </Button>
                  </div>
                  {isRecording && (
